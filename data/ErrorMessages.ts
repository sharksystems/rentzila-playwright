export enum ErrorMessages {
    ...
    phoneInvalid = "Телефон не пройшов валідацію",
    nameTooShort = "Ім'я має містити щонайменше дві літери",
    ...
    priceTooSmall= "Мінімальна вартiсть має бути не менше 1000 грн",
}